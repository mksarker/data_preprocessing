...
class DrawCurve:
	...
	def __init__(self,savepath):
		...
		self.colorbar=['red','green','blue', 'orange','yellow', 'cyan', 'black']
		self.linestyle=['-','-.','--',':','--', '-.', '-']
	...
	def roc(self):
		...
		plt.legend()
		plt.savefig(self.savepath+'%s_ROC.pdf'%self.dataName, dpi=800)
		#plt.show()
	...
	def pr(self):
		...
		plt.legend()
		plt.savefig(self.savepath+'%s_PR.pdf'%self.dataName, dpi=800)
		#plt.show()
